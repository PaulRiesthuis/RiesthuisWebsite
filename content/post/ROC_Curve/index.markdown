...
```
##   old_items_tim new_items_tim     confidence
## 1            50           250   extreme weak
## 2            50           250      very weak
## 3            50           400    fairly weak
## 4           150            50  fairly strong
## 5           500            25    very strong
## 6           200            25 extreme strong
```
...
```
##   old_items_john new_items_john     confidence
## 1             50            100   extreme weak
## 2             75            400      very weak
## 3             75            300    fairly weak
## 4            500             50  fairly strong
## 5            200             75    very strong
## 6            100             75 extreme strong
```
...
```
##   old_items_tim new_items_tim     confidence hit_tim far_tim
## 1            50           250   extreme weak    0.05   0.250
## 2            50           250      very weak    0.10   0.500
## 3            50           400    fairly weak    0.15   0.900
## 4           150            50  fairly strong    0.30   0.950
## 5           500            25    very strong    0.80   0.975
## 6           200            25 extreme strong    1.00   1.000
```
...
```
##   old_items_john new_items_john     confidence hit_john far_john
## 1             50            100   extreme weak    0.050    0.100
## 2             75            400      very weak    0.125    0.500
## 3             75            300    fairly weak    0.200    0.800
## 4            500             50  fairly strong    0.700    0.850
## 5            200             75    very strong    0.900    0.925
## 6            100             75 extreme strong    1.000    1.000
```
